...
function checkWinner(a, b, c) {
    ...
    b--;
    c--;
    if ((span[a].dataset.player === span[b].dataset.player) && (span[b].dataset.player === span[c].dataset.player) && (span[a].dataset.player === "o") && isGameover == false) {
...
function draw() {
    ...
    doucument.getElementsByTagName("body")[0].appenChild(div);
    window.isGameOver = true;
    moves = 0;
}